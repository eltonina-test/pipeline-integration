...
using CrossCutting.PdfHelper.HtmlRenderer.Core;
using CrossCutting.PdfHelper.HtmlRenderer.Core.Entities;
using CrossCutting.PdfHelper.HtmlRenderer.Core.Handlers;
using CrossCutting.PdfHelper.HtmlRenderer.Core.Utils;

namespace CrossCutting.PdfHelper.HtmlRenderer.Adapters
{
    /// <summary>
    ...
    public abstract class RAdapter
    {
        ...
        public RImage GetLoadingImage()
        {
            if (_loadImage == null)
            {
                var stream = typeof(HtmlRendererUtils).Assembly.GetManifestResourceStream("CrossCutting.PdfHelper.HtmlRenderer.Core.Utils.ImageLoad.png");
                if (stream != null)
        ...
        public RImage GetLoadingFailedImage()
        {
            if (_errorImage == null)
            {
                var stream = typeof(HtmlRendererUtils).Assembly.GetManifestResourceStream("CrossCutting.PdfHelper.HtmlRenderer.Core.Utils.ImageError.png");
                if (stream != null)
