...
namespace CrossCutting.PdfHelper.HtmlRenderer.Core.Handlers
{
    /// <summary>
    ...
    internal sealed class FontsHandler
    {
        ...
        /// </summary>
        private readonly ConcurrentDictionary<string, string> _fontsMapping = new ConcurrentDictionary<string, string>(StringComparer.InvariantCultureIgnoreCase);

        /// <summary>
        /// collection of all installed and added font families to check if font exists
        /// </summary>
        private readonly ConcurrentDictionary<string, RFontFamily> _existingFontFamilies = new ConcurrentDictionary<string, RFontFamily>(StringComparer.InvariantCultureIgnoreCase);
